/*******************************************************************************
modified on 2012-08-21 by Craig Versek <cversek@gmail.com> 

NOTE:  this file has been modified from its original version the changes
are to the header:
- #define TERM_CHAR '\r'
+ #define TERM_CHAR '\n'
+ #define SERIALCOMMANDLENGTH 16
...
+ typedef struct _callback {
+ 	char command[SERIALCOMMANDLENGTH];
+ 	void (*function)();
+ } SerialCommandCallback;   
